    ...
    <ThemeProvider>
      <main className='bg-[#f3f3f5]'>
        ...
        <Section className="relative bg-[url('./assets/hero.png')] bg-cover text-white overflow-hidden" >
          ...
          "
        ></div>
          <Container display='grid' gridColumns='2' padding='pt-[140px]' className="relative z-10 gap-x-24 gap-y-24">
       ...
       <Section id='Low-Code'>
        <Container>
          <div className='mb-4 text-center'>
            ...
            <Heading size='md'>Vantagens do Low-Code</Heading>
          </div>
            <Carousel>
              ...
              ' >
                <div className='grid grid-flow-row gap-y-8 lg:justify-items-start items-center'>
                  ...
                  <div className='border-[2px] border-[#db324b] border-dashed py-12 px-8 rounded-2xl'>
                    <ul className='flex flex-col gap-3 text-xl items-center lg:items-start'>
