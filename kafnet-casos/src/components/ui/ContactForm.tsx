...
export const FormZoho: React.FC = () => {
  ...
  // These hidden values are preserved from your original markup
  const ZOHO_ACTION =
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    // Remove the zc_spmSubmit element (scriptless submit behavior)
    removeZcSpmSubmit();

    // If you want to submit into a new tab like the original, keep target="_blank" on the form
    // and call native submit()
    // We show an optimistic success popup (original opened Zoho in new tab)
    try {
      // Wait a tick to ensure DOM updated (zc_spmSubmit removed)
      setTimeout(() => {
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto ">
        ...
        >
          ...
          <div className="grid grid-cols-1  gap-3 md:grid-cols-2">
            <label className="flex flex-col">
              ...
              <input
                ...
                className="mt-1 p-4 w-full border text-lg rounded-md bg-white w-full"
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-4 border text-lg rounded-md bg-white"
                placeholder="Nome"
              />
            </label>
            ...
            <label className="flex flex-col md:col-span-2">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-4 text-lg border rounded-md bg-white"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 items-center">
              <input
                ...
                maxLength={100}
                placeholder="Captcha"
                className="p-4 border rounded-md text-lg flex-1 w-full bg-white"
                type="text"
                required
              />
          ...
          <div className="text-md flex text-gray-500">* Campos obrigatórios</div>
 
            <button
              type="submit"
              id="zcWebOptin"
              name="SIGNUP_SUBMIT_BUTTON"
              className="px-4 py-1.5 text-[22px] font-bold bg-[#db324b]  text-white rounded-md disabled:opacity-60 m-0"
              disabled={submitting}
            >
